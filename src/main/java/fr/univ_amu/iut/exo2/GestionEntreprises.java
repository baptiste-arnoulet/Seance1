...
public class GestionEntreprises {
    public static void main(String[] args) {
        ...
        Techniciens techniciens1 = new Techniciens(5, 6, "patrick", "leon", 2, LocalDate.of(1993, 06, 13), LocalDate.of(2015, 10,25), 2.5,4, 6, 3);
        Commerciaux commerciaux1 = new Commerciaux(4,5,"lol", "papaa", 4, LocalDate.of(1997, 05, 23), LocalDate.of(2015, 10,25), 2,5, 200, 4);
        Vendeur vendeur1 = new Vendeur(4,5,"mdre", "gdqf", 4, LocalDate.of(1997, 05, 23), LocalDate.of(2015, 10,25), 2,5, 150, 4);
        Représentant représentant1 = new Représentant(4,5,"gaga", "fafa", 3, LocalDate.of(1997, 05, 23), LocalDate.of(2015, 10,25), 2,5, 170, 4);
